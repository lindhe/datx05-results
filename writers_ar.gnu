...
set output './png/number_of_writers_ar.png'
...
#################################     PLOT     #################################
plot 'test-writers_ar_summary.csv'\
using 1:3 with linespoints lt 2 title "AR Read Latency",\
'' u 1:2 w linesp lt 1 tit "AR Write Latency",\
