...
set output './png/number_of_readers_ar.png'
...
#################################     PLOT     #################################
plot 'test-readers_ar_summary.csv'\
using 1:2 with linespoints lt 2 title "AR Read Latency",\
'' u 1:3 w linesp lt 1 tit "AR Write Latency",\
